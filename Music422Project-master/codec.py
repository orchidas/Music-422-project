...
#    vMantissa = np.vectorize(Mantissa)
    ...
    peakSPL = bit.calcPeakSPLPerBand(4*mdctLines**2, sfBands, sfBands.nBands )
    # perform bit allocation using SMR results
    bitAlloc = BitAlloc(bitBudget, maxMantBits, sfBands.nBands, sfBands.nLines, SMRs)
    
    #bitAlloc = bit.BitAllocUniform (bitBudget, maxMantBits, sfBands.nBands, sfBands.nLines, SMR=None)
    #bitAlloc = bit.BitAllocConstSNR(bitBudget, maxMantBits, sfBands.nBands, sfBands.nLines, peakSPL)
    #bitAlloc = bit.BitAllocConstMNR (bitBudget, maxMantBits, sfBands.nBands, sfBands.nLines, SMRs)
