...
from psychoac_ import ScaleFactorBands, AssignMDCTLinesFromFreqLimits  # defines the grouping of MDCT lines into scale factor bands
import sys
...
if __name__=="__main__":
    ...
    input_filename = "AudioFiles/ABBA.wav"
    coded_filename = "AudioFIles/coded.pac"
    output_filename = "AudioFiles/outputABBA.wav"
