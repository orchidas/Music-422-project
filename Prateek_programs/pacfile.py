...
class PACFile(AudioFile):
    ...
    def ReadDataBlock(self, codingParams):
        ...
        LRorMS = np.zeros(codingParams.sfBands.nBands , dtype = 'int')
        ...
        for iCh in range(codingParams.nChannels):
            ...
            for iBand in range(codingParams.sfBands.nBands):
                LRorMS[iBand]=pb.ReadBits(1)

        # print (scaleFactor,bitAlloc,mantissa,overallScaleFactor,codingParams,LRorMS)
        decodedData = self.Decode(scaleFactor,bitAlloc,mantissa,overallScaleFactor,codingParams,LRorMS)
    ...
    def WriteDataBlock(self,data, codingParams , myhuffyman):
        ...
        (scaleFactor,bitAlloc,mantissa,overallScaleFactor,LRorMS) = self.Encode(fullBlockData,codingParams, myhuffyman)  # returns a tuple with all the block-specific info not in the file header
    ...
    def Decode(self,scaleFactor,bitAlloc,mantissa,overallScaleFactor,codingParams,LRorMS , myhuffyman):
        """
        ...
        return codec.Decode(scaleFactor,bitAlloc,mantissa,overallScaleFactor,codingParams,LRorMS)
...
if __name__=="__main__":
    ...
    coded_filename = "outputs/abba_19.pac"
    output_filename = "outputs/abba_19.wav"
...
#    for Direction in ("Decode"):
        ...
        if Direction == "Encode":
            ...
            print "Saved "+str(myhuffyman.getBitDeposit())+" Bits!"
